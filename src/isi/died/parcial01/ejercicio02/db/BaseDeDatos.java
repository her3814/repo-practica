...
/**
 * Esta clase es falsa, tiene como objetivo simular la logica que empleariamos
 * si enviamos datos a una base de datos pero en realidad no ejecuta nada. Es
 * util para poder entender como gestionar excepciones * @author marti
 *
 */
public class BaseDeDatos {
	...
	public void guardar(Inscripcion i) throws BaseDeDatosExcepcion {
		if (i == null)
			throw new BaseDeDatosExcepcion(i);
