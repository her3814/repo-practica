...
public interface MySysAcad {
	...
	/**
	 * crea una nueva instancia de Inscripcion y asigna la inscripcion a la lista de
	 * inscripciones del alumno, de la materia y del docente
	 * 
	 ...
	 * 
	 * @param m
	 * @return calcula para una materia el promedio de todos los examenes, pero
	 *         teniendo en cuenta solo aquellos que fueron aprobados.
	 */
